...
class TestExecuteQuery:
    ...
    @pytest.mark.asyncio
    async def test_execute_query_simple_endpoint(self, mock_httpx_client_context):
        ...
        mock_instance = mock_httpx_client_context
    ...
    @pytest.mark.asyncio
    async def test_execute_query_with_jq_filter(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_connection_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_timeout_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_invalid_json_response(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_multiple_endpoints(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_with_custom_timeout(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_upstream_http_500_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_upstream_http_404_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_upstream_http_403_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_upstream_http_502_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_multiple_endpoints_second_fails_http_error(
        self, mock_httpx_client_context
    ):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_connection_refused_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_network_unreachable_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_read_timeout_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_write_timeout_error(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_multiple_endpoints_first_fails(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_malformed_json_response(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_empty_malformed_response(self, mock_httpx_client_context):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_multiple_endpoints_malformed_response_second(
        self, mock_httpx_client_context
    ):
    ...
    @pytest.mark.asyncio
    async def test_execute_query_http_error_with_error_status(self, mock_httpx_client_context):
